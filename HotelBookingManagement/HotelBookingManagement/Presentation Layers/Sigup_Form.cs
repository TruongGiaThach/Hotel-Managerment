...
namespace HotelBookingManagement
{
    public partial class SignUp_Form : Form
    {
        ...
        string custumerID;
        public SignUp_Form(Login_Form form1, ref TaiKhoan user)
        {
            InitializeComponent();
        ...
        private bool signUp(string user, string pass, string repass, string cusID)
        {
            ...
            return TaiKhoan_DAL.Instance.themTaiKhoan(user, TaiKhoan.encode(pass), cusID);
        }
        private bool addCustumer(string name, string email)
        {
            ...
            return KhachHang_DAL.Instance.themKhachHang(name, email, "", "");
        }
